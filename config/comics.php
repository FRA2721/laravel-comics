<?php
// I create an array for the header section to controll pages & links routes;
...
return [
    ...
    // footer array links dc comics data
    'dcComics' => [
    ...
    // footer array links dc data
    'dc' => [

        // term of use link data
        [
            'name' => 'Term Of Use',
            'href' => '',
        ],

        // privacy policy (new) link data
        [
            'name' => 'Privacy Policy (New)',
            'href' => '',
        ],

        // ad choices link data
        [
            'name' => 'Ad Choices',
            'href' => '',
        ],

        // advertising link data
        [
            'name' => 'Advertising',
            'href' => '',
        ],
        ...
        // subscriptions link data
        [
            'name' => 'Subscriptions',
            'href' => '',
        ],

        // talent workshops link data
        [
            'name' => 'Talent Workshops',
            'href' => '',
        ],
        
        // cpsc certificates link data
        [
        ...
        // shop helper link data
        [
            'name' => 'Shop Helper',
            'href' => '',
        ],

        // contact us link data
        [
            'name' => 'Contact Us',
            'href' => '',
        ],
    ...
    'sites' => [
        ...
        // dc universe link data
        [
            'name' => 'DC Universe',
            'href' => '',
        ],

        // dc power visa link data
        [
            'name' => 'DC Power Visa',
            'href' => '',
        ],
    ...
    'shop' => [
        ...
        // shop dc collectibles link data
        [
